...
def test_model_inference_salary_over50k():
    ...
    ft_data = FeatureData(age=90, workclass='Local-gov', fnlgt=227796, education="Masters", education_num=14,
                          marital_status="Married-civ-spouse", occupation="Exec-managerial", relationship="Husband",
                          race="White", sex="Male", capital_gain="20051", capital_loss=0,
...
def test_model_inference_salary_not_over50k():
    ...
    ft_data = FeatureData(age=90, workclass='?', fnlgt=166343, education="1st-4th", education_num=2,
                          marital_status="Widowed", occupation="?", relationship="Not-in-family",
                          race="Black", sex="Female", capital_gain="0", capital_loss=0,
